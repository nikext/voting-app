  ...
  return (
    <div className="mt-16">
      ...
      <p className="text-lg max-w-md mb-8">
        Create your test so that other people can vote on their favorite Image
        and help you redesign or pick the best options.
      </p>
      ...
      >
        ...
        <Button>Create Image Test</Button>
      </form>
    </div>
  );
}
